    ...
    <section>
        <div class="container-fluid">
            @if(in_array("products-add", $all_permission))
                <a href="{{route('recipes.create')}}" class="btn btn-primary add-product-btn"><i class="dripicons-plus"></i>
                    {{__('db.add_recipes')}}</a>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>{{__('db.The correct column order is')}} (image, name*, code*, type*, category*, unit_code*, cost*,
                        price*, product_details, variant_name, item_code, additional_price)
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="sample_file/sample_products.csv" class="btn btn-primary btn-block btn-md"><i
