...
<body>
                ...
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <span class="brand-big">
                        @if($general_settings->site_logo)
                            ...
                            &nbsp; &nbsp;
                        @endif
                        <h1 class="d-inline">{{$general_settings->site_title ?? "No title"}}</h1>
                    </span>
                ...
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    ...
                    @can('user')
                        <li
                            ...
                            <ul id="users" class="collapse list-unstyled ">
                                ...
                                <li id="user-roles"><a href={{route('user-roles')}}>{{__('User Roles and Access')}}</a></li>
                                @endcan --}}
                                @can('role-access-user')
                    ...
                    @can('view-details-employee')
                        <li class="has-dropdown {{ (request()->is('staff*')) ? 'active' : '' }}">
                            <a href="#employees" aria-expanded="false" data-toggle="collapse"> <i
                                    class="dripicons-user-group"></i><span>{{__('db.Employees')}}</span></a>
                    ...
                    <li class="has-dropdown {{ (request()->is('core_hr*')) ? 'active' : '' }}">
                        ...
                        <ul id="Core_hr" class="collapse list-unstyled">
                            ...
                            @can('view-promotion')
                                <li id="promotion"><a href="{{route('promotions.index')}}">{{__('db.Promotion')}}</a>
                                </li>
                            @endcan
                            @can('view-award')
                            ...
                            @can('view-resignation')
                                <li id="resignation"><a href="{{route('resignations.index')}}">{{__('db.Resignations')}}</a>
                                </li>
                            @endcan
                            @can('view-complaint')
                                <li id="complaint"><a href="{{route('complaints.index')}}">{{__('db.Complaints')}}</a>
                                </li>
                            @endcan
                            @can('view-warning')
                            ...
                            @can('view-termination')
                                <li id="termination"><a href="{{route('terminations.index')}}">{{__('db.Terminations')}}</a>
                                </li>
                            @endcan
                    ...
                    <li class="has-dropdown {{ (request()->is('organization*')) ? 'active' : '' }}"><a
                            ...
                            <i class="dripicons-view-thumb"></i><span>{{__('db.Organization')}}</span></a>
                        <ul id="Organization" class="collapse list-unstyled ">
                            @can('view-company')
                                <li id="company"><a href="{{route('companies.index')}}">{{__('db.Company')}}</a></li>
                            @endcan
                            @can('view-department')
                                <li id="department"><a href="{{route('departments.index')}}">{{__('db.Department')}}</a>
                                </li>
                            @endcan
                            ...
                            @can('view-designation')
                                <li id="designation"><a href="{{route('designations.index')}}">{{__('db.Designation')}}</a>
                                </li>
                            @endcan
                    ...
                    @can('timesheet')
                        <li class="has-dropdown {{ (request()->is('timesheet*')) ? 'active' : '' }}"><a href="#Timesheets"
                            ...
                            <ul id="Timesheets" class="collapse list-unstyled ">
                                ...
                                <li id="date_wise_attendance"><a href="{{route('date_wise_attendances.index')}}"> {{__('Date
                                        wise Attendances')}}</a>
                                </li>


                                <li id="monthly_attendance"><a href="{{route('monthly_attendances.index')}}"> {{__('Monthly
                                        Attendances')}}</a>
                                </li> --}}
                                {{-- @endcan --}}

                                @can('edit-attendance')
                                    <li id="update_attendance"><a href="{{route('update_attendances.index')}}">
                                            {{__('Add/Update Attendances')}}</a>
                                    </li>
                                @endcan

                                @can('import-attendance')
                                    <li id="import_attendance"><a href="{{route('attendances.import')}}">
                    ...
                    @can('performance')
                        <li class="has-dropdown {{ (request()->is('performance*')) ? 'active' : '' }}">
                            ...
                            <ul id="performance" class="collapse list-unstyled ">
                                @can('view-goal-type')
                                    <li id="goal-type"><a
                                            href="{{route('performance.goal-type.index')}}">{{__('Goal type')}}</a></li>
                                @endcan
                                @can('view-goal-tracking')
                                    <li id="goal-tracking"><a
                                            href="{{route('performance.goal-tracking.index')}}">{{__('Goal Tracking')}}</a></li>
                                @endcan
                                @can('view-indicator')
                                    <li id="indicator"><a
                                            href="{{route('performance.indicator.index')}}">{{__('Indicator')}}</a></li>
                                @endcan
                                @can('view-appraisal')
                                    <li id="appraisal"><a
                                            href="{{route('performance.appraisal.index')}}">{{__('Appraisal')}}</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcan
                    ...
                    <li class="has-dropdown {{ (request()->is('report*')) ? 'active' : '' }}"><a href="#HR_Reports"
                        ...
                        <ul id="HR_Reports" class="collapse list-unstyled ">
                            ...
                            {{-- @can('report-payslip')
                            <li id="payslip_report"><a href="{{route('report.payslip')}}">{{__('Payslip Report')}}</a>
                            </li>
                            @endcan --}}

                            <!--New added-->
                            <li id="attendance"><a href="{{route('attendances.index')}}">{{__('Daily Attendances')}}</a>
                            </li>
                            ...
                            <li id="attendance_report"><a href="{{route('report.attendance')}}">{{__('Attendance
                                    Report')}}</a>
                            </li>
                            @endcan --}}
                            ...
                            {{-- New --}}
                            @can('report-pension')
                                <li id="pension_report"><a href="{{route('report.pension')}}">{{__('Pension Report')}}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    <li
                        ...
                        <ul id="Training" class="collapse list-unstyled ">
                            ...
                            @endcan
                            @can('view-trainer')
                                <li id="trainers"><a href="{{route('trainers.index')}}">{{__('db.Trainers')}}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    <li
                        ...
                        <ul id="Events_Meetings" class="collapse list-unstyled ">
                            @can('view-event')
                                <li id="events"><a href="{{route('events.index')}}">{{__('db.Events')}}</a>
                                </li>
                            @endcan
                            @can('view-meeting')
                                <li id="meetings"><a href="{{route('meetings.index')}}">{{__('db.Meetings')}}</a>
                                </li>
                            @endcan
                        </ul>
                        @endcan
                    ...
                    <li class="has-dropdown {{ (request()->is('project-management*')) ? 'active' : '' }}">
                        ...
                        <ul id="Project_Management" class="collapse list-unstyled ">
                            ...
                            @endcan
                            @can('view-invoice')
                                <li id="invoices"><a href="{{route('invoices.index')}}">{{trans(('file.Invoice'))}}</a>
                                </li>
                            @endcan
                            @can('access-variable_type')
                    ...
                    <li class="has-dropdown {{ (request()->is('file_manager*')) ? 'active' : '' }}">
                        ...
                        <a href="#file_manager" aria-expanded="false" data-toggle="collapse"> <i
                                class="dripicons-store"></i><span>{{__('File Manager')}}</span>
                        </a>
                        @endcan
    ...
    <div class="page">
        ...
        <footer class="main-footer">
            <div class="container-fluid">
                <p>&copy; {{$general_settings->site_title ?? "no title"}} | {{ __('Developed by')}} <a href="#"
                        class="external">{{$general_setting->developed_by}}</a></p>
            </div>
        </footer>
    </div>
