        ...
        selectedValue: old('type', $lims_product_data->type)
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button id="genbutton" type="button" class="btn btn-sm btn-default"
                                                        title="{{__('db.Generate')}}"><i class="fa fa-refresh"></i></button>
                                                </div>
                                            </div>
                                                                                                    ...
                                                                                                    @foreach($product_list as $key => $id)
                                                                                                        ...
                                                                                                        if ($lims_product_data->variant_list && $variant_list[$key]) {
                                                                                                            ...
                                                                                                            $variant_list[$key] = '';
                                                                                                                                                    ...
                                                                                                                                                    <td>
                                                                                                                                                        <div class="input-group">
                                                                                                                                                            <input type="number" class="form-control wastage_percent"
                                                                                                                                                                name="wastage_percent[]"
                                                                                                                                                                value="{{@$wastage_percent[$key] ?? 0 }}" min="0"
                                                                                                                                                                step="any" />
                                                                                                                                                            <div class="input-group-append">
                                                                                                                                                    ...
                                                                                                                                                    <td>
                                                                                                                                                        <div class="input-group" style="max-width: unset">
                                                                                                                                                            <input type="number" class="form-control qty" min="1"
                                                                                                                                                                name="product_qty[]" value="{{ $qty_list[$key] ?? 1 }}"
                                                                                                                                                                step="any" placeholder="Qty" aria-label="Quantity">
                                                                                                                                                                ...
                                                                                                                                                                <select name="combo_unit_id[]" style="width: 112px;"
                                                                                                                                                                    ...
                                                                                                                                                                    @foreach ($combo_unit as $row)
                                                                                                                                                                        <option value="{{ $row->id }}"
                                                                                                                                                                            ...
                                                                                                                                                                            data-operator="{{ $row->operator }}" @if ($lims_product_data->unit_id == $row->id) 'selected'
                                                                                                                                                                            @endif>
                                                                                                                                                                            {{ $row->unit_name }}
                                                                                                                                                                        </option>
                                                                                                                                                                    @endforeach
                                                                                                                                                    ...
                                                                                                                                                    <td><input type="number" class="form-control subtotal"
                                                                                                                                                            name="subtotal[]" value="0.00" step="any" /></td>
                                                                                                                                                    ...
                                                                                                                                                    <input type="hidden" class="product_unit_cost" name=""
                                                                                                                                                        value="{{$product->cost}}" />
                                                                                                                                                    <input type="hidden" class="product_unit_price" name=""
                                    ...
                                    {{-- <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="production_cost" class="form-control"
                                                value="{{ $lims_product_data->production_cost ?? 0}}">
                                        </div>
                                    </div> --}}
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div id="cost" class="col-md-4 @if(Auth::user()->role_type > 2) d-none @endif">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="cost" value="{{$lims_product_data->cost}}" required
                                                class="form-control product_cost" step="any">
                                    ...
                                    <div id="profit_margin" class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="profit_margin"
                                                value="{{$lims_product_data->profit_margin}}" required class="form-control"
                                                step="0.01">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="price" value="{{$lims_product_data->price}}" required
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="daily_sale_objective" class="form-control" step="any"
                                                value="{{$lims_product_data->daily_sale_objective}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label>{{__('db.Product Tax')}} <span class="text-danger d-none"
                                                    id="tax-required">*</span></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <input type="number" name="warranty" min="1" class="form-control"
                                                    style="width: 48%;" placeholder="{{__('db.eg: 1')}}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <input type="number" name="guarantee" min="1" class="form-control"
                                                    style="width: 48%;" placeholder="{{__('db.eg: 1')}}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if($field->type == 'text')
                                                        <input type="text" name="{{$field_name}}"
                                                            value="{{$lims_product_data->$field_name}}" class="form-control"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($images as $key => $image)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img src="{{url('images/product', $image)}}" height="60"
                                                                        width="60">
                                    ...
                                    <div class="col-md-12 mt-2" id="diffPrice-option">
                                        @if($lims_product_data->is_diffPrice)
                                            <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice" value="1"
                                                    checked>&nbsp;
                                                {{__('db.This product has different price for different warehouse')}}</h5>
                                        @else
                                            <h5><input name="is_diffPrice" type="checkbox" id="is-diffPrice" value="1">&nbsp;
                                                {{__('db.This product has different price for different warehouse')}}</h5>
                                        @endif
                                    ...
                                    <div class="col-md-12 mt-3" id="batch-option">
                                        @if($lims_product_data->is_batch)
                                            <h5><input name="is_batch" type="checkbox" id="is-batch" value="1" checked>&nbsp;
                                    ...
                                    <div class="col-md-12 mt-3" id="imei-option">
                                        @if($lims_product_data->is_imei)
                                            <h5><input name="is_imei" type="checkbox" id="is-imei" value="1" checked>&nbsp;
                                    ...
                                    @if($lims_product_data->is_variant)
                                        <div class="col-md-12 mt-3" id="variant-option">
                                            <h5 class="d-none"><input name="is_variant" type="checkbox" id="is-variant"
                                                    value="1" checked>&nbsp; {{__('db.This product has variant')}}</h5>
                                        </div>
                                    @endif
                                    <div class="col-md-12" id="variant-section">
                                                    ...
                                                    $noOfVariantValue += count(explode(',', $lims_product_data->variant_value[$key]));
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-1 form-group mt-2"
                                                                                            ...
                                                                                            <button type="button" class="delVarOption btn btn-danger btn-sm mr-3"><i
                                        ...
                                        <div class="col-md-12 form-group">
                                            <button type="button" class="btn btn-primary add-more-variant"><i
                                        ...
                                        <div class="row">
                                            <div class="col-md-4" id="promotion_price">
                                                ...
                                                <input type="number" name="promotion_price"
                                                    value="{{$lims_product_data->promotion_price}}" class="form-control"
                                                    step="any" />
                                            </div>
                                            <div id="start_date" class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="starting_date"
                                                        value="{{$lims_product_data->starting_date}}" id="starting_date"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <h5>
                                            <input name="is_fbr_invoice_product" type="checkbox" id="is_fbr_invoice_product"
                                                value="1" {{ $lims_product_data->is_fbr_invoice_product ? 'checked' : '' }}>
                                            &nbsp; {{__('db.This Product has FBR Invoice Attributes')}}
                                        </h5>
                                    </div>

                                    <div class="col-md-12" id="fbr-section"
                                        style="{{ $lims_product_data->is_fbr_invoice_product ? '' : 'display:none;' }}">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>{{__('db.HS Code')}} *</label>
                                                    <input type="text" name="hs_code" class="form-control"
                                                        value="{{$lims_product_data->hs_code}}" {{ $lims_product_data->is_fbr_invoice_product ? 'required' : '' }} />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>{{__('db.Fixed or Retail Price')}}</label>
                                                    <input type="number" name="fixed_notified_value_or_retail_price"
                                                        class="form-control" step="any"
                                                        value="{{$lims_product_data->fixed_notified_value_or_retail_price ?? 0}}" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>{{__('db.Sales Tax Withheld')}}</label>
                                                    <input type="number" name="sales_tax_withheld_at_source"
                                                        class="form-control" step="any"
                                                        value="{{$lims_product_data->sales_tax_withheld_at_source ?? 0}}" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>{{__('db.Extra Tax')}}</label>
                                                    <input type="number" name="extra_tax" class="form-control" step="any"
                                                        value="{{$lims_product_data->extra_tax ?? 0}}" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>{{__('db.Further Tax')}}</label>
                                                    <input type="number" name="further_tax" class="form-control" step="any"
                                                        value="{{$lims_product_data->further_tax ?? 0}}" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>{{__('db.FED Payable')}}</label>
                                                    <input type="number" name="fed_payable" class="form-control" step="any"
                                                        value="{{$lims_product_data->fed_payable ?? 0}}" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sro_schedule_no" class="form-control"
                                                        value="{{$lims_product_data->sro_schedule_no}}" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sro_item_serial_no" class="form-control"
                                                        value="{{$lims_product_data->sro_item_serial_no}}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
