...
@section('content')
    ...
    <section>
        <div class="container-fluid">
            ...
            @can('products-add')
                <a href="{{route('products.create')}}" class="btn btn-primary btn-sm add-product-btn btn-icon"><i
                        class="dripicons-plus"></i> {{__('db.add_product')}}</a>
            @endcan
            @can('products-import')
                <a href="#" data-toggle="modal" data-target="#importProduct" class="btn btn-primary btn-sm add-product-btn btn-icon"><i
                        class="dripicons-copy"></i> {{__('db.import_product')}}</a>
            @endcan

            <button type="button" class="btn btn-warning btn-sm btn-icon" id="toggle-filter">
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>{{__('db.The correct column order is')}} (image, name*, code*, type*, brand, category*, unit_code*,
                        cost*, profit_margin(%), price, product_details, variant_name, item_code, additional_price)
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="sample_file/sample_products.csv" class="btn btn-info"><i
