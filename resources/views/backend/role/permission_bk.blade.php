            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
						        ...
						        @php
									...
									<tr>
										...
										@foreach ($permissions as $perm)
											...
											<td class="text-center">
												 @if(in_array($key, $admin_permissions))
												...
												@else
												<i class="fa fa-lock text-muted" title="Not assigned to you"></i>
												@endif
											</td>
										@endforeach
									</tr>
									...
									@if(in_array("sidebar_product", $admin_permissions))
									<tr>
										<td>{{ __('db.product') }}</td>
										@foreach ($permissions as $perm)
									...
									@if(in_array("sidebar_purchase", $admin_permissions))
									<tr>
								...
								@if(in_array("sidebar_sale", $admin_permissions))
								<tr>
									<td>{{ __('db.Sale') }}</td>
									@foreach ($permissions as $perm)
						...
						@if(in_array("fbr-errors", $admin_permissions))
				        <tr class="fbr-row">
				            <td>FBR</td>
				            <td class="report-permissions" colspan="5">
				            	<span>
				                    <div aria-checked="false" aria-disabled="false">
				                        <div class="checkbox">
				                            @if(in_array("fbr-errors", $all_permission))
				                            <input type="checkbox" value="1" id="fbr-errors" name="fbr-errors" checked>
				                            @else
				                            <input type="checkbox" value="1" id="fbr-errors" name="fbr-errors">
				                            @endif
				                            <label for="fbr-errors" class="padding05">View FBR Posting Errors &nbsp;&nbsp;</label>
				                        </div>
				                    </div>
				                </span>
				            </td>
				        ...
				        <tr class="purchase-return-row">
								...
								@if(in_array("sidebar_sales", $admin_permissions))
								<tr>
						            <td>{{__('db.POS')}}</td>
						            <td class="report-permissions" colspan="5">
										<span>
								...
								@if(in_array("sidebar_accounting", $admin_permissions))
								...
								@endif
								@if(in_array("sidebar_hrm", $admin_permissions))
						        <tr class="hrm-row">
								...
								@if(in_array("sidebar_reports", $admin_permissions))
						        <tr class="report-row">
						            <td>{{__('db.Reports')}}</td>
						            <td class="report-permissions" colspan="5">
						            	<span>
								...
								@if(in_array("addons", $admin_permissions))
								<tr class="addon-row">
									<td>Addonds</td>
									<td class="addons">
										<span>
								...
								@if(in_array("sidebar_settings", $admin_permissions))
						        <tr>
