@extends('backend.layout.main') @section('content')
    ...
    <div class="alert alert-warning alert-dismissible text-center"><button type="button" class="close" data-dismiss="alert"
            aria-label="Close"><span aria-hidden="true">&times;</span></button>Please select at least one packing slip to
        create a challan</div>
    ...
    <section>
        <div class="container-fluid">
            <form action="{{route('challan.create')}}" method="POST" id="challan-form">
                ...
                <button id="create-challan-btn" type="submit" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
