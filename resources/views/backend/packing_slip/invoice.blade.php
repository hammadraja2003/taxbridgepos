...
<body>
    ...
    <div style="max-width:1000px;margin:0 auto">
        <div class="hidden-print">
            <table>
                <tr>
                    <td><a href="{{route('packingSlip.index')}}" class="btn btn-info"><i class="fa fa-arrow-left"></i>
                            Back</a> </td>
                    <td><button onclick="window.print();" class="btn btn-primary"><i class="fa fa-print"></i>
                            Print</button></td>
                </tr>
            </table>
                ...
                <tbody>
                    <tr>
                        <td rowspan="2" class="text-center">
                            <img src="{{url('logo', $general_setting->site_logo)}}"
                                style="margin:10px 0;max-height: 80px;">
                        </td>
                        <td colspan="3">
