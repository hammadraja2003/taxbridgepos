...
@section('content')
    ...
    <section>
        <div class="container-fluid">
            <a href="{{route('qty_adjustment.create')}}" class="btn btn-primary btn-sm"><i class="dripicons-plus"></i>
                {{__('db.Add Adjustment')}}</a>
        </div>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">{{__('db.action')}}<span
