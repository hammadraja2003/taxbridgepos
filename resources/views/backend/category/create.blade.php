        ...
        <div class="container-fluid">
            ...
            @can('categories-add')
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#category-modal"><i
                        class="dripicons-plus"></i> {{__("db.Add Category")}}</button>&nbsp;
            @endcan
            @can('categories-import')
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#importCategory"><i
                        class="dripicons-copy"></i> {{__('db.Import Category')}}</button>
            @endcan
        </div>
