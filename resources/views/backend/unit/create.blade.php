@extends('backend.layout.main') @section('content')
    ...
    <section>
        <div class="container-fluid">
            @can('unit-add')
                <a href="#" data-toggle="modal" data-target="#createUnitModal" class="btn btn-primary btn-sm"><i
                        class="dripicons-plus"></i> {{__('db.Add Unit')}}</a>&nbsp;
            @endcan
            @can('unit-import')
                <a href="#" data-toggle="modal" data-target="#importUnit" class="btn btn-primary btn-sm"><i
                        class="dripicons-copy"></i> {{__('db.Import Unit')}}</a>
            @endcan
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="italic"><small>{{__('db.The field labels marked with * are required input fields')}}.</small>
                    </p>
                    <form>
                        ...
                        <div class="form-group operation_value">
                            <label>{{__('db.Operation Value')}}</label><input type="number" name="operation_value"
                                placeholder="{{ __('db.Enter operation value') }}" class="form-control" step="any" />
                        </div>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>{{__('db.The correct column order is')}} (unit_code*, unit_name*, base_unit [unit code], operator,
                        operation_value) {{__('db.and you must follow this')}}.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="sample_file/sample_unit.csv" class="btn btn-info"><i
