                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <p><small>
                                                        {{__('db.The correct column order is')}} (product_code, quantity,
                                                        purchase_unit_code, cost, discount_per_unit, tax_name)
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label></label><br>
                                                <a href="../sample_file/sample_purchase_products.csv"
