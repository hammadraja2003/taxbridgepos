                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <p><small>{{__('db.The correct column order is')}} (product_code, quantity,
                                                        sale_unit_code, price, discount_per_unit, tax_name)
                                                        {{__('db.and you must follow this')}}.
                                                        {{__('db.For Digital product sale_unit will be n/a')}}.
                                                        {{__('db.All columns are required')}}</small></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label></label><br>
                                                <a download href="../sample_file/sample_sale_products.csv"
                                                    class="btn btn-primary"><i class="dripicons-download"></i>
                                                    {{__('db.Download Sample File')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
