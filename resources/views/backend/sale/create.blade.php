                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required id="biller_id" name="biller_id"
                                                        ...
                                                        @foreach($lims_biller_list as $biller)
                                                            ...
                                                            @endif>{{$biller->name . ' (' . $biller->company_name . ')'}}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            ...
                                            <div class="search-box form-group mb-2" style="position:relative">
                                                <div class="input-group pos">
                                                    <input style="border: 1px solid #5579a4;" type="text"
                                            ...
                                            <span class="not-found" style="color: red; display: none;">Product not
                                                found</span>
                                        </div>
                                    </div>
                                    <div class="row mt-5">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="order_discount_value" id="order-discount-val"
                                                    class="form-control numkey" value="0.00" step="0.01" />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="shipping_cost" value="0" class="form-control"
                                                    step="any" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>{{__('db.Attach Document')}}</label> <i class="dripicons-question"
                                                    data-toggle="tooltip"
                                    ...
                                    <div id="payment">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="alert alert-danger d-none p-2 position-absolute"
                                                    id="paying-amount-error">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-condensed totals">
                                                ...
                                                <td><strong>{{__('db.Extra Tax')}}</strong>
                                                    <span class=" pull-right"
                                                        id="extra-tax">{{number_format(0, $general_setting->decimal, '.', '')}}</span>
                                                </td>
                                                <td><strong>{{__('db.Further Tax')}}</strong>
                                                    <span class=" pull-right"
                                                        id="further-tax">{{number_format(0, $general_setting->decimal, '.', '')}}</span>
                                                </td>
                                                <td><strong>{{__('db.Fed Tax')}}</strong>
                                                    <span class=" pull-right"
                                                        id="fed-tax">{{number_format(0, $general_setting->decimal, '.', '')}}</span>
                                                </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="credit_limit" class="form-control" value="0" step="any"
                                        min="0">
                                </div>
                            </div>
                            <div class="col-md-6">
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" id="close-installment-modal-x" data-bs-dismiss="modal"
