...
@section('content')
                        ...
                        <nav class="navbar">
                            <div class="dropdown">
                                <a class="btn menu-btn dropdown-toggle-no-arrow" type="button" data-toggle="dropdown"
                                    aria-expanded="false" role="button"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
    ...
    $transfer_permission_active = $role_has_permissions_list->where('name', 'transfers-index')->first();
                            ...
                            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                ...
                                <li class="nav-item">
                                    <a id="customer-display" href="{{route('sales.customerDisplay')}}" data-toggle="tooltip"
                                        title="{{__('db.Customer Display Screen')}}"><svg xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                            class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                @if($today_sale_permission_active)
                                    <li class="nav-item d-none d-lg-block">
                                        <a href="" id="today-sale-btn" data-toggle="tooltip"
                                            title="{{__('db.Today Sale')}}"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    $authUser = Auth::user()->role_type;
                            ...
                            <div class="row ml-2 mt-3">
                                @foreach($lims_category_list as $category)
                                    <div class="col-md-3 col-6 category-img text-center" data-category="{{$category->id}}">
                                        @if($category->image)
                                            <img src="{{env('PUB_PATH') . 'images/category/' . $category->image}}" />
                                        @else
                                            <img src="{{env('PUB_PATH') . 'images/zummXD2dvAtI.png'}}" />
                                        @endif
                            ...
                            <div class="row ml-2 mt-3">
                                @foreach($lims_brand_list as $brand)
                                    <div class="col-md-3 col-6 brand-img text-center" data-brand="{{$brand->id}}">
                                        @if($brand->image)
                                            <img src="{{env('PUB_PATH') . 'images/brand/' . $brand->image}}" />
                                        @else
                                            <img src="{{env('PUB_PATH') . 'images/zummXD2dvAtI.png'}}" />
                                        @endif
                    ...
                    <div id="collapseProducts" class="">
                        <div class="d-flex justify-content-between product-btns">
                            <button class="btn btn-block btn-primary mt-0 ml-0 mr-0"
                                style="border-radius:0px;border-right:1px solid white;"
                    ...
                    <div class="row">
                                        ...
                                        <div class="form-group top-fields">
                                            ...
                                            <select required id="biller_id" name="biller_id" class="selectpicker form-control"
                                                ...
                                                @foreach($lims_biller_list as $biller)
                                                    <option value="{{$biller->id}}" @if($biller->id == $biller_id) selected @endif>
                                            ...
                                            <select required name="customer_id" id="customer_id"
                                                ...
                                                @foreach($lims_customer_list as $customer)
                                                    ...
                                                    <option data-points={{ $customer->points }}
                                                        ...
                                                        value="{{$customer->id}}" @if($customer->id == $customer_id) selected
                                                        @endif>{{$customer->name}}
                                                        @if($customer->wa_number)({{$customer->wa_number}})@endif
                                                    </option>
                                                @endforeach
                                            </select>
                                            @if($customer_active)
                        ...
                        <div class="col-md-1 col-12">
                            <a class="btn btn-primary btn-block more-options" data-toggle="collapse" href="#moreOptions"
                                role="button" aria-expanded="false" aria-controls="moreOptions">
    ...
    $accountSelection = $role_has_permissions_list->where('name', 'account-selection')->first();
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{__('db.FBR Posting')}} * <x-info
                                                    title="The FBR posting is automatically selected based on the POS settings. You can change it here temporarily for this invoice only. To change it permanently, update it in the POS settings."
                                                    type="info" /></label>
                                            @php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @elseif($field->type == 'select')
                                                        ...
                                                        <select class="form-control"
                                                            ...
                                                            @foreach($option_values as $value)
                                                                <option value="{{$value}}"
                                                                    @if($value == $field->default_value){{'selected'}}@endif>{{$value}}
                                                                </option>
                                                            @endforeach
                                                        </select>
                        ...
                        <div class="col-12 pl-0 pr-0">
                            <div class="search-box form-group mb-2">
                                <div class="input-group pos">
                                    <input style="border: 1px solid #5579a4;margin-right: 10px;" type="text"
                                        name="product_code_name" id="product-search-input"
                                        placeholder="Scan/Search product by name/code/IMEI (at least 3 characters)"
                        ...
                        <div class="col-12 totals"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-6">
                                    ...
                                    <strong
                                        id="further-tax">{{number_format(0, $general_setting->decimal, '.', '')}}</strong>
                                </div>
    ...
    $payment_methods = array_values($payment_methods);
                        ...
                        <div class="column-5">
                            <button style="background-color: #ffc107;" type="button" class="btn btn-sm btn-custom"
                                data-toggle="modal" data-target="#recentTransaction"><svg xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>{{__('db.Address')}} <span
                                                        class="asterisk asterisk-fbr">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>{{__('db.Credit Limit')}} <x-info
                                                        title="Leave it blank for unlimited credit" type="info" /></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <label>{{__('db.This Customer Belongs to FBR Invoicing')}} <x-info
                                                        title="If checked, customer will be used for fbr invoicing"
                                                        type="info" /></label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 fbr-input">
                                            <div class="form-group">
                                                <label>{{__('db.This Customer is FBR Registered')}} <x-info
                                                        title="If checked, customer will be used for fbr invoicing"
                                                        type="info" /></label>
    ...
    $lims_account_list = \App\Models\Account::where('is_active', true)->get();
        ...
        <div id="add-supplier-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
            class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-1">
                                ...
                                <select name="supplier_id" id="supplier_list" class="form-control" data-live-search="true"
                                    data-live-search-style="begins" title="Select Supplier..." required>
                                    <option value=""></option>
                                </select>
                            </div>
                            <div class="col-md-6 mt-1">
        ...
        @if($lims_pos_setting_data && $lims_pos_setting_data->cash_register)
            ...
            <div id="cash-register-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button id="close-installment-modal-x" type="button" data-dismiss="modal" aria-label="Close"
                    ...
                    <div class="modal-body">
                        ...
                        <div id="installmentFields" class="row" style="display: none;">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="installment_plan[name]" value="12 Months"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" name="installment_plan[total_amount]"
                                    id="installment_total" readonly>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="1" class="form-control" name="installment_plan[months]" min="1"
                                    value="12">
                            </div>
...
@push('scripts')
    ...
    <audio id="audio" src="{{env('PUB_PATH') . '/beep/beep-07.mp3'}}" autoplay="false"></audio>
    <script>
        function playSound() {
        ...
        @endif
            ...
            function populateProduct(response) {
                ...
                $.each(response.data['name'], function (index) {
                    ...
                    tableData += '<div class="product-img sound-btn" title="' + response.data['name'][index] + '" data-code = "' + response.data['code'][index] + '" data-qty="' + response.data['qty'][index] + '" data-imei="' + response.data['is_imei'][index] + '" data-embedded="' + response.data['is_embeded'][index] + '" data-batch="" data-price="' + response.data['price'][index] + '"><img  src="{{env('PUB_PATH') . "/images/product"}}/' + image + '" width="100%" /><p>' + response.data['name'][index] + '</p><span>[' + response.data['code'][index] + ']</span> <span class="d-block">Qty: ' + response.data['qty'][index] + '</span></div>';
                });
