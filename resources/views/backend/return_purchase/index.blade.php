        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="row mb-3 ml-0">
                    ...
                    <div class="col-md-5 mt-3 @if(\Auth::user()->role_type > 2){{'d-none'}}@endif">
            ...
            @if(in_array("purchase-return-add", $all_permission))
                <a href="#" data-toggle="modal" data-target="#add-purchase-return" class="btn btn-primary btn-sm"><i
                        class="dripicons-plus"></i> {{__('db.Add Return')}}</a>
            @endif
        </div>
