@extends('backend.layout.main') @section('content')
    ...
    $temp_unit_operation_value = [];
                                                        ...
                                                        @foreach($lims_product_return_data as $product_return)
                                                            ...
                                                            $product_batch_data = \App\Models\ProductBatch::select('batch_no')->find($product_return->product_batch_id);
                                                                                                                ...
                                                                                                                <td><input type="number" class="form-control qty" name="qty[]"
                                                                                                                        value="{{$product_return->qty}}" max="{{$product_return->qty}}" required step="any" />
                                                                                                                </td>
                                                                                                                <td class="net_unit_cost">
                                                                                                                    {{ number_format((float) $product_return->net_unit_cost, $general_setting->decimal, '.', '')}}
                                                                                                                </td>
                                                                                                                <td class="discount">
                                                                                                                    {{ number_format((float) $product_return->discount, $general_setting->decimal, '.', '')}}
                                                                                                                </td>
                                                                                                                <td class="tax">
                                                    ...
                                                    <tfoot class="tfoot active">
                                                        ...
                                                        <th id="total">
                                                            {{ number_format((float) $lims_return_data->total_cost, $general_setting->decimal, '.', '')}}
                                                        </th>
                                                        <th><i class="dripicons-trash"></i></th>
                                                    </tfoot>
                                                </table>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('.qty').on('input', function() {
                ...
                // Agar user zyada type kare to max set kar do
                if(val > max) {
                    $(this).val(max);
            ...
            // Form submit pe bhi double check kar lo
