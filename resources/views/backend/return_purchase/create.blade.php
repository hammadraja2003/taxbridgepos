                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>{{__('db.Actual Qty')}}</th>
                                                            <th>{{__('db.Qty')}}</th>
                                                            <th>{{__('db.Returned Qty')}}</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @php 
                                                            ...
                                                            if($product_purchase->qty == $product_purchase->return_qty){
                                                            ...
                                                            $product_batch_data = \App\Models\ProductBatch::select('batch_no')->find($product_purchase->product_batch_id);
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input type="hidden" name="actual_qty[]" class="actual-qty"
                                                                                                                        value="{{$product_purchase->qty - $product_purchase->return_qty}}">
                                                                                                                    <input type="number" class="form-control qty" name="qty[]"
                                                                                                                        value="{{$product_purchase->qty - $product_purchase->return_qty}}" required step="any"
                                                                                                                        max="{{$product_purchase->qty - $product_purchase->return_qty}}" />
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    {{ $product_purchase->return_qty }}
                                                                                                                </td>
                                                                                                                <td class="net_unit_cost">
                                                                                                                    {{ number_format((float) $product_purchase->net_unit_cost, $general_setting->decimal, '.', '')}}
                                                                                                                </td>
                                                                                                                <td class="discount">
                                                                                                                    {{ number_format((float) $product_purchase->discount, $general_setting->decimal, '.', '')}}
                                                                                                                </td>
                                                                                                                <td class="tax">
                                                                                                                    {{ number_format((float) $product_purchase->tax, $general_setting->decimal, '.', '')}}
                                                                                                                </td>
                                                                                                                <td class="sub-total">
                                                                                                                    {{ number_format((float) $product_purchase->total, $general_setting->decimal, '.', '')}}
                                                                                                                </td>
                                                                                                                <td>
                                                                                                                    @if($already_returned)
                                                                                                                        <span class="text-danger">Returned</span>
                                                                                                                    @else
                                                                                                                        <input type="checkbox" class="is-return" name="is_return[]"
