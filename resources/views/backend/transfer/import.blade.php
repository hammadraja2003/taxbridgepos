                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p>{{__('db.The correct column order is')}} (product_code, quantity, product_unit, product_cost, tax_name) {{__('db.and you must follow this')}}. {{__('db.All columns are required')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label></label><br>
                                            <a href="../sample_file/sample_transfer_products.csv" class="btn btn-primary"><i class="dripicons-download"></i> {{__('db.Download Sample File')}}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
