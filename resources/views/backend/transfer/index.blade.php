@extends('backend.layout.main') @section('content')
    ...
    <section>
        <div class="container-fluid">
                ...
                <div class="row mb-3 ml-0">
                    ...
                    <div class="col-md-4 mt-3 @if(\Auth::user()->role_type > 2){{'d-none'}}@endif">
                        <div class="form-group top-fields">
                            ...
                            <select id="from_warehouse_id" name="from_warehouse_id" class="selectpicker form-control"
                    ...
                    <div class="col-md-4 mt-3 @if(\Auth::user()->role_type > 2){{'d-none'}}@endif">
                        <div class="form-group top-fields">
                            ...
                            <select id="to_warehouse_id" name="to_warehouse_id" class="selectpicker form-control"
                                data-live-search="true" data-live-search-style="begins">
                                <option value="0">{{__('db.All Warehouse')}}</option>
                                @foreach($lims_warehouse_list as $warehouse)
            ...
            @can('transfers-add')
                <a href="{{route('transfers.create')}}" class="btn btn-primary btn-sm"><i class="dripicons-plus"></i>
                    {{__('db.Add Transfer')}}</a>&nbsp;
            @endcan
        </div>
