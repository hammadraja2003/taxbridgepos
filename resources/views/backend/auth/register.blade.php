...
<head>
  ...
  <!-- login stylesheet-->
  <link rel="stylesheet" href="{{ env('ASSETS_PATH') . '/css/auth.css' }}" id="theme-stylesheet" type="text/css">
  <!-- Google fonts - Roboto -->
    ...
    <div class="container">
      <div class="form-outer text-center d-flex align-items-center">
        <div class="form-inner">
          ...
          <p>{{__('db.Already have an account')}}? </p><a href="{{url('login')}}" class="signup">{{__('db.LogIn')}}</a>
        </div>
      </div>
    </div>
  </div>
