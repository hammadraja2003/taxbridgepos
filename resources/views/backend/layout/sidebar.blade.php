<ul id="side-main-menu" class="side-menu list-unstyled d-print-none">
    ...
    @can('sidebar_product') 
        @if(packageHasFeature('product_and_categories'))
            <li>
                <a href="#product" aria-expanded="false" data-toggle="collapse"> <i
                        class="dripicons-list"></i><span>{{__('db.product')}}</span></a>
                ...
                <ul id="product" class="collapse list-unstyled ">
                    ...
                    @endcan
                    @can('adjustment')
                        <li id="adjustment-create-menu"><a href="{{route('qty_adjustment.create')}}">{{__('db.Add Adjustment')}}</a>
                        </li>
                        <li id="adjustment-list-menu"><a href="{{route('qty_adjustment.index')}}">{{__('db.Adjustment List')}}</a>
                        </li>
                    @endcan
                </ul>
            </li>
    ...
    @can('sidebar_purchase')
        @if(packageHasFeature('purchase_and_sale'))
        <li>
            ...
            <ul id="purchase" class="collapse list-unstyled ">
                ...
                @can('purchases-import')
                    <li id="purchase-import-menu"><a
                            href="{{url('purchases/purchase_by_csv')}}">{{__('db.Import Purchase By CSV')}}</a></li>
                @endcan
                @can('purchase-return-index')
                    <li id="purchase-return-menu"><a href="{{route('return-purchase.index')}}">{{__('db.Purchase Return')}}</a>
                    </li>
                @endcan
            </ul>
        </li>
    ...
    @can('sidebar_quotation')
        @if(packageHasFeature('quotation'))
        <li>
            <a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i
                    class="dripicons-document"></i><span>{{__('db.Quotation')}}</span></a>
    ...
    @can('sidebar_transfer')
        @if(packageHasFeature('stock_transfer'))
        <li>
            ...
            <ul id="transfer" class="collapse list-unstyled ">
                ...
                @can('transfers-import')
                    <li id="transfer-import-menu"><a
                            href="{{url('transfers/transfer_by_csv')}}">{{__('db.Import Transfer By CSV')}}</a></li>
                @endcan
            </ul>
        </li>
        @endif
        ...
        @if(packageHasFeature('income'))
            <li>
                ...
                <ul id="income" class="collapse list-unstyled ">
                    <li id="income-cat-menu"><a href="{{route('income_categories.index')}}">{{__('db.Income Category')}}</a>
                    </li>
                    @can('incomes-index')
    ...
    @can('sidebar_accounting')
        @if(packageHasFeature('accounting'))
        <li class="">
    ...
    @can('sidebar_manufacturing')
        @if(packageHasFeature('manufacturing'))
            <li>
                <a href="#manufacturing" aria-expanded="false" data-toggle="collapse"> <i
                        class="fa fa-industry"></i><span>{{__('db.Manufacturing')}}</span></a>
                ...
                <ul id="manufacturing" class="collapse list-unstyled ">
                    ...
                    <li id="production-create-menu"><a href="{{route('productions.create')}}">{{__('db.Add Production')}}</a>
                    </li>
        ...
        @if(packageHasFeature('settings'))
            <li>
                ...
                <ul id="setting" class="collapse list-unstyled ">
                    ...
                    @endcan
                    @can('discount_plan')
                        <li id="discount-plan-list-menu"><a href="{{route('discount-plans.index')}}">{{__('db.Discount Plan')}}</a>
                        </li>
                    @endcan
                    @can('discount')
                    ...
                    @endif
                    @can('customer_group')
                        <li id="customer-group-menu"><a href="{{route('customer_group.index')}}">{{__('db.Customer Group')}}</a>
                        </li>
                    @endcan
                    @can('currency')
                    ...
                    @endcan
                    <li id="user-menu"><a href="{{route('user.profile', ['id' => Auth::id()])}}">{{__('db.User Profile')}}</a>
                    </li>
                    @can('create_sms')
    ...
    <li id="logout-menu">
        <a href="{{ route('logout') }}"
            onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
                class="dripicons-power"></i>{{ __('db.logout') }}</a>
