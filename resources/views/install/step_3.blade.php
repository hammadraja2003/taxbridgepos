...
<html lang="en">
<head>
    <title>TaxBridgeSaas Installer | Step-3</title>
		    ...
		    <div class="content">
		        ...
		        <form action="{{ route('install-process') }}" method="post">
		            ...
		            <fieldset>
		                ...
		                <input type='text' class="form-control" name="db_username" placeholder="Ex: taxbridge2023" required>
		                <label>Database Password</label>
		                <input type='password' class="form-control" name="db_password" placeholder="Ex: PXsfdf1542" required>
		                <label>Database Name</label>
		                <input type='text' class="form-control" name="db_name" placeholder="Ex: taxbridge_db" required>
