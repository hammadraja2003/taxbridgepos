...
<html lang="en">
<head>
    <title>SalesBridgeSaas Installer | Step-2</title>
    ...
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            ...
            <div class="content">
                ...
                <br/><?php echo $ltext; ?><br/>Sorry. The requirements of SalepProSaaS is not available on your server. Please contact with us- [EMAIL_ADDRESS] with this code- <?php echo $passed; ?> Or contact with your server administrator.<br><br>
