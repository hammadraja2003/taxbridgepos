...
class Common
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $role_has_permissions = Cache::remember($key_prefix . 'role_has_permissions', 60 * 60 * 24 * 365, function () {
            return DB::connection('master')->table('role_has_permissions')->where('role_id', Auth::user()->role_id)->get();
        });
