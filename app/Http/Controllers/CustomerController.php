...
class CustomerController extends Controller
{
    ...
    public function customerReturns($customer_id)
    {
        $returns = DB::table('returns')
            ...
            ->map(function ($return) {
                return [
                    ...
                    'total_qty' => number_format($return->total_qty, 2),
                    'total_discount' => number_format($return->total_discount, 2),
                    'total_tax' => number_format($return->total_tax, 2),
                    'total_price' => number_format($return->total_price, 2),
                    'grand_total' => number_format($return->grand_total, 2),
